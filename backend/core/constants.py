...
TIMEOUT = 600  # 10 min
CALCITE_IMAGE_ID = LITERATURE_IMAGE_ID = 'ami-069a4b2ecb4033d02'
# LeetCode-RQ1
LEETCODE_IMAGE_ID_RQ1 = 'ami-09a235a7ec64b26b6'
# LeetCode-RQ2
LEETCODE_IMAGE_ID_RQ2 = 'ami-05d04fbe2c1f21512'
LEETCODE_FILE_WO_IC_INDICES = {603, 607, 1132}
BACKUP_SUFFIX = '__BACKUP__'
T2_SMALL_DEVICE = 't2.small'
T2_MEDIUM_DEVICE = 't2.medium'
T2_LARGE_DEVICE = 't2.large'
REMOTE_PYTHON = '/home/ubuntu/anaconda3/envs/py311/bin/python'
